...
<NextSeo
    ...
    description='The Blue Flag API uses API keys to authenticate requests.'
/>
...
<div class="method-example-code">
    <div class="method-example-request-topbar">
        <div class="method-example-request-title">AUTHENTICATED REQUEST</div>
    </div>
...
<div class="method-example-note">
    <div class="method-example-response-topbar">
        <div class="method-example-response-title">Your API Key</div>
    </div>
