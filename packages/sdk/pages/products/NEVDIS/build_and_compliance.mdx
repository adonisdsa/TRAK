...
<NextSeo
    title='Build and Compliance'
    description='A plate or label fitted on the vehicle by the manufacturer or importer. Usually specific to a month and year.'
/>
