...
export default function CreatedWithSection() {
    return (
        <Container theme="light" className="workwith-container paddingY4" autoMinHeight={false}>
            <Section className="createdHome paddingY4">
                <h2 className="productHeader createdHeader">Created with learners at the centre: This is TRAK, a platform that goes beyond your average training platform.</h2>
